...
const Contactme = () => {
  return (
    <div className=' flex flex-row flex-wrap h-max justify-around items-center gap-5 bg-black m-15 rounded-md p-10' >
        ...
        <form className=' h-120 w-100 items-center flex flex-col gap-2 box-border '  >
